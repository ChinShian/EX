    ...
    <div class="top">
      ...
      <div id="nav">
        <a href="https://www.digiwin.com/tw" target="_blank">
          <img class="logo" src="https://www.digiwin.com/tw/dsc/Library/images/logo.png" alt="鼎新官網" width="90" height="29" />
        </a>
        <ul class="link">
          <li class="line_L">
            <a href="javascript:;">
            ...
            <ul class="subLink">
              <li>
                <a href="https://www.digiwin.com/tw/dsc/marketing/WB003008/web/01/" target="_blank">Workflow ERP</a>
              </li>
            </ul>
          </li>
          <li>
            ...
            <ul class="subLink">
              <li>
                <a href="https://www.digiwin.com/tw/dsc/marketing/WB003008/web/02_cn/" target="_blank">東南亞投資設廠</a>
              </li>
              <li>
                <a href="https://www.digiwin.com/tw/dsc/marketing/WB003008/web/05/index.html" target="_blank">越南電子發票</a>
              </li>
              <li>
                <a href="https://www.digiwin.com/tw/dsc/marketing/WB003008/web/04/index.html" target="_blank">越南勞動法</a>
              </li>
            </ul>
          </li>
          <li>
            ...
            <ul class="subLink">
              <li>
                <a href="https://www.digiwin.com/tw/case.html" target="_blank">行動辦公平台</a>
              </li>
              <li>
                <a href="https://www.digiwin.com/tw/case.html" target="_blank">手機LINE簽核</a>
              </li>
            </ul>
          </li>
          <li class="Phone">
